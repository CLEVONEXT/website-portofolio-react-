    ...
    >
      ...
      >
        ...
        <motion.div variants={itemVariants} className="mb-6">
          <div className="inline-block px-4 py-2 bg-accent-soft border border-accent-soft rounded-full mb-4">
        ...
        <motion.div
          variants={itemVariants}
          className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-20 sm:mb-24"
        >
          <button
        ...
        <motion.div
          variants={itemVariants}
          className="flex flex-wrap justify-center items-center gap-4 sm:gap-6 mb-20 sm:mb-24"
        >
          <a
            href={siteConfig.socials.github}
            target="_blank"
            rel="noopener noreferrer"
            className="group p-3 sm:p-4 bg-elevated hover:bg-accent-soft border border-accent-soft hover:border-accent rounded-lg transition-all duration-300 transform hover:scale-110"
          >
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-accent group-hover:opacity-80">
