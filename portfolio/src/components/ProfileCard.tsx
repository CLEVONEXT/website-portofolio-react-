...
const ProfileCardComponent = ({
  ...
  useEffect(() => {
    ...
    const enterHandler = handlePointerEnter;
    const leaveHandler = handlePointerLeave;
    const orientationHandler = handleDeviceOrientation;

    shellEl.addEventListener('pointerenter', enterHandler);
    shellEl.addEventListener('pointermove', moveHandler);
    shellEl.addEventListener('pointerleave', leaveHandler);
    ...
    return () => {
      shellEl.removeEventListener('pointerenter', enterHandler);
      shellEl.removeEventListener('pointermove', moveHandler);
      shellEl.removeEventListener('pointerleave', leaveHandler);
